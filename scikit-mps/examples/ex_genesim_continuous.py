...
# %% [markdown]
# # GENESIM with a continuous training image
#
...
# %% [markdown]
# ## Setup the MPS object and load continuous training image
...
# %% [markdown]
# ## Run a single simulation with distance weighting
...
# %% [markdown]
# ## Sweep over distance parameters
#
# Loop over combinations of `distance_max` and `distance_pow` and display the resulting realizations.
